...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=363588');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "363588");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "d93e08992868003ce814bcd84f428b11418c33472dc972d7f9712ca7be7be047");
define('CREATED_TIMESTAMP', "1686959362");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor363588');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor363588');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "greggnomatous.github.io",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "greggnomatous.github.io",
));
